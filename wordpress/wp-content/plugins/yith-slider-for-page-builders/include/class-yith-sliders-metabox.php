...
class YITH_Sliders_Metabox {
	...
	public function save_slider_controls( $post_id ) {
		...
		if ( isset( $_POST['yith_slider_control_autoplay_timing'] ) ) {
			update_post_meta( $post_id, 'yith_slider_control_autoplay_timing', intval( wp_unslash( $_POST['yith_slider_control_autoplay_timing'] ) ) );
		}
		if ( isset( $_POST['yith_slider_control_container_max_width'] ) ) {
			update_post_meta( $post_id, 'yith_slider_control_container_max_width', intval( wp_unslash( $_POST['yith_slider_control_container_max_width'] ) ) );
		}
