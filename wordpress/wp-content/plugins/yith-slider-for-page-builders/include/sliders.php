...
function yith_slider_for_page_builders_single_slide_save_meta( $post_id ) {
	...
	if ( isset( $_POST['single_slide_background_size'] ) ) {
		update_post_meta( $post_id, 'single_slide_background_size', sanitize_text_field( wp_unslash( $_POST['single_slide_background_size'] ) ) );
	}
	if ( isset( $_POST['single_slide_background_position'] ) ) {
		update_post_meta( $post_id, 'single_slide_background_position', sanitize_text_field( wp_unslash( $_POST['single_slide_background_position'] ) ) );
	}
	if ( isset( $_POST['single_slide_background_repeat'] ) ) {
		update_post_meta( $post_id, 'single_slide_background_repeat', sanitize_text_field( wp_unslash( $_POST['single_slide_background_repeat'] ) ) );
	}
	if ( isset( $_POST['single_slide_background_color'] ) ) {
		update_post_meta( $post_id, 'single_slide_background_color', sanitize_text_field( wp_unslash( $_POST['single_slide_background_color'] ) ) );
	}
...
add_filter( 'manage_posts_columns', 'yith_slider_column_order' );
