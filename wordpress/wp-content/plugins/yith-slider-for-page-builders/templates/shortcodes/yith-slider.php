...
function yith_slider_for_page_builders_slider_sc( $atts ) {
	...
	ob_start();
	?>
	<div class="yith-slider <?php echo esc_attr( $slider_layout ); ?> yith-slider-<?php echo esc_attr( $atts['slider'] ); ?>" <?php echo esc_attr( $slider_style ); ?>>
		<?php
		foreach ( $slides as $slide ) :
			...
			if ( '' != $slide_container_max_width ) {
				$slide_container_max_width = '<style type="text/css"> .slide-id-' . esc_attr( $slide_id ) . ' .slider-container { max-width: ' . $slide_container_max_width . 'px;}</style>';
